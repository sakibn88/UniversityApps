...
namespace UniversityApps.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="StudentId,RegistrationId,Name,Email,ContactNo,Date,Address,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
                //Regex PhnFormat= new Regex(@"^([0-9\(\)\/\+ \-]*)$");


                //if (PhnFormat.IsMatch(student.ContactNo))
                //{
                ...
                db.SaveChanges();
                TempData["success"] = "Student is added successfully";
                TempData["reg"] = "Your registration id is: " + student.RegistrationId + " Please memorize this id.";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="StudentId,RegistrationId,Name,Email,ContactNo,Date,Address,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
